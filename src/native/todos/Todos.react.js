...
class Todos extends Component {
    ...
    render() {
        ...
        if (todos.size === 0) {
            return (
                <View style={styles.centeredView}>
                    <Image source={require('./img/EmptyState.png')} style={styles.icon}/>
        ...
        return (
            <ScrollView>
                {list.map(todo => <View key={todo._id} style={styles.row}>
...
export default connect(state => ({todos: state.todos.map}), todosActions)(Todos);
